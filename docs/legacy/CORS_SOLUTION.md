> ⚠️ **DEPRECATED / LEGACY** — Mayar sudah tidak digunakan. Gateway pembayaran aktif sekarang adalah **DOKU**. Dokumen ini diarsipkan hanya sebagai referensi historis. Lihat [`docs/legacy/MAYAR_DEPRECATION.md`](./MAYAR_DEPRECATION.md).
