...
|---|---|---|
| [2026-08-05-phase-3-jadwal-iklan-terpadu](2026-08-05-phase-3-jadwal-iklan-terpadu.md) | ⬜ **belum dimulai — mulai dari sini** | Tab "Jadwal Iklan" terpadu di admin. Memuat prosedur merge branch, urutan Task 9→10→12→Phase 3→11, dan tiga keputusan yang harus diambil di awal |
...
Kalau keduanya dikerjakan berdekatan, **design-system lebih dulu lebih murah**: Phase 3
membangun permukaan admin baru, dan membangunnya di atas token yang belum ada berarti
menulis ulang recipe warna/spacing-nya belakangan. Tapi design-system juga menyentuh
**seluruh** app sekaligus (task 1-nya membalik urutan cascade CSS), jadi ia rilis
berisiko-lebar sementara Phase 3 berisiko-sempit.

Ini belum diputuskan. Yang penting: **jangan mengeksekusi keduanya dalam satu branch tanpa
memutuskan urutannya lebih dulu.**
