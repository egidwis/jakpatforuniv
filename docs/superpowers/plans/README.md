...
|---|---|---|
| [2026-09-10-phase-4-penjadwalan-swalayan](2026-09-10-phase-4-penjadwalan-swalayan.md) | ✅ **DIEKSEKUSI — jalur utama selesai & diuji browser 2026-09-17** · ⚠️ satu lubang sadar tersisa · ⬜ commit belum di-push | Tombol "Jadwalkan Iklan Lagi" jadi swalayan di dashboard peneliti. **Peneliti memesan perpanjangan sendiri tanpa admin**, terverifikasi di produksi (`ordinal 4`, hold selaras 0 menit dengan umur link DOKU). ⚠️ **"Kesiapan" di dalam dokumennya SUDAH BASI** — kelima penghalang 10 Sep sudah tumbang per 17 Sep (`reward_pools` 900 baris, `sql/86`+`88` diterapkan, `p_slot_reserved_at` ada, penjaga `create-payment.js` ber-lingkup jadwal). ⚠️ **Tersisa: ganti tanggal untuk `ordinal ≥ 2`** masih menolak lewat `rebookExtensionUnsupported` — primitif pesan-ulang ber-lingkup JADWAL belum ditulis, dan **9 jadwal perpanjangan sudah berada di keadaan yang menampilkan kalender buntu itu**. Status berjalan: [§00AB](../../jadwal-iklan-progress.md) |
