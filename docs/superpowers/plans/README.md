...
|---|---|---|
| [2026-09-10-phase-4-penjadwalan-swalayan](2026-09-10-phase-4-penjadwalan-swalayan.md) | ✅ **SELESAI & DITUTUP 2026-09-17** — dideploy, diuji browser, `sql/50`·`86`·`88`·`89`·`90` live | Penjadwalan swalayan di dashboard peneliti. **Peneliti menjadwalkan, membatalkan & memesan ulang perpanjangan sendiri tanpa admin** — terverifikasi di produksi. ⚠️ **"Kesiapan" di dalam dokumennya SUDAH BASI** (kelima penghalang 10 Sep sudah tumbang); ia dipertahankan sebagai arkeologi, bukan keadaan sekarang. ⚠️ Peneliti TIDAK bisa menukar jadwal yang masih berjalan — itu wewenang admin; yang ada adalah PESAN ULANG sesudah hangus. Utang tersisa: pembatalan oleh PENELITI belum mematikan link DOKU (gerbang admin 403 + RLS `invoices` menelan galatnya — BUKAN salah DOKU, Cancel Order sudah aktif), cron pelepas slot belum ada. Status: [§00AB](../../jadwal-iklan-progress.md) |
