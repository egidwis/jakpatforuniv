...
|---|---|---|
| [2026-09-10-phase-4-penjadwalan-swalayan](2026-09-10-phase-4-penjadwalan-swalayan.md) | ⬜ **belum dieksekusi — ditulis 2026-09-10 sebagai serah-terima.** Nol baris kode berubah · 🔴 **empat dari lima penghalang masih berdiri**, tiga di antaranya mengubah kode jalur uang yang SEDANG BERJALAN · 🔴 **satu keputusan pemilik produk memblokir urutan rilis** | Tombol "Jadwalkan Iklan Lagi" jadi swalayan di dashboard peneliti. Prasyarat link bayar **sudah lunas** 10 Sep ([§00Z](../../jadwal-iklan-progress.md)) — Phase 4 melipatgandakan link yang beredar, jadi jebakan itu harus tertutup lebih dulu. Permintaannya naik: **18 perpanjangan seumur hidup, 11 sejak 1 Agustus** (dari 14/7 dua hari sebelumnya). ⚠️ Yang MASIH memblokir, semuanya diverifikasi ke produksi 10 Sep: `reward_pools` (`sql/50`) **tabelnya tidak ada dan berkasnya belum pernah ditulis**; `sql/86` belum ditulis dan tanda tangan `create_ad_schedule` **tidak punya `p_slot_reserved_at`** sama sekali (jadi "hold 1 jam" belum punya wujud di DB); pelepasan hold jadwal ke-2 **nol implementasi** (`slot_reserved_at` terisi di 0 dari 18 jadwal ordinal ≥2); dan **tiga penjaga order-scoped di `create-payment.js` menolak 100% sasaran Phase 4** — `payment_status === 'paid'` justru definisi order yang mau memperpanjang. ⚠️ **Dua hal berubah sesudah rencananya dirancang:** Cancel Order baru diaktifkan tanpa satu pun bukti keberhasilan dan **tidak pernah mencakup kartu kredit**, sementara Phase 4 justru melahirkan tagihan tersalip jauh lebih sering; dan **jendela ke 1 Okt tinggal tiga minggu** untuk dua rilis jalur uang berturut-turut — dokumen ini merekomendasikan **mencabut keputusan no. 5** dan mengirim `sql/50` sendiri dulu |
