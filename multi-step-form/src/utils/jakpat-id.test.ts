...
check('strips jakpat. prefix', normalizeJakpatId('jakpat.ks8oh'), 'ks8oh');
...
for (const id of ['ks8oh', 'qt0yt', '50bx0', '0bxr5', '8uvvh', '2fuad', 'z8wii', 'vq4c9']) {
...
check('non-alphanumeric', jakpatIdWarning('ks8o!') !== null, true);
check('bare jakpat becomes empty then silent', jakpatIdWarning('jakpat.'), null);
