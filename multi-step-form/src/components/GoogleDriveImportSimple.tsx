      ...
      {!isAuthenticated ? (
        ...
        <div className="google-step-card">
          <div className="google-step-header">
            ...
            <div className="google-step-content">
              <h3 className="google-step-title">Hubungkan Google Account</h3>
              <p className="google-step-description">
                Kami memerlukan akses read-only ke Google Drive dan Google Forms Anda
              </p>
            </div>
          </div>
          ...
          <div className="google-permissions-list">
            <div className="permission-item">
              ...
              <span>Google Drive (read only)</span>
            </div>
            <div className="permission-item">
              <CheckCircle className="permission-icon" size={18} />
              <span>Google Forms (read only)</span>
            </div>
          </div>
        ...
        <div className="google-step-card google-step-success">
          <div className="google-step-header">
            ...
            <div className="google-step-content">
              <h3 className="google-step-title">Terhubung ke Google Drive</h3>
          ...
          <div className="google-step-header" style={{ marginTop: '1.5rem' }}>
            ...
            <div className="google-step-content">
              <h3 className="google-step-title">Pilih Google Form</h3>
              <p className="google-step-description">
                Klik tombol di bawah untuk membuka file picker dan pilih form Anda
              </p>
            </div>
          </div>
