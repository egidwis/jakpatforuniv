...
export const translations = {
  en: {
    ...
    statusScheduling: "Schedule Reserved",
    ...
    payNow: "Pay Now",
    billNotIssuedYet: "Your schedule is locked. The invoice is being prepared by our team — we’ll email you as soon as it’s ready.",
    ...
    noSubmissionsDesc: "You haven't submitted any survey for distribution yet. Choose a service above or create a new form to get started.",
    ...
    prizePerWinnerLabel: "Prize",
    prizePerWinnerPlaceholder: "25,000",
    winnerCountLabel: "Winners",
    winnerCountPlaceholder: "2",
    winnerCountUnit: "winners",
    respondentUnit: "respondents",
    ...
    slotErrorFull: "Quota for the selected date range is full. Please choose a different date.",
    slotErrorAvailabilityUnknown: "We could not load schedule availability, so we cannot lock this date yet. Please retry.",
    slotAvailabilityRetry: "Retry loading schedule availability",
    ...
    */
    ...
    scheduleHoldHint: "The schedule is held for 1 hour after you lock it, so you have time to complete the payment.",
    ...
    lockingSlotLoading: "Locking schedule...",
    sendingForReviewLoading: "Sending your survey...",
    slotLockedSuccess: "Schedule locked. Complete the payment to keep it.",

    // Phase B — countdown on the payment page
    paymentPhaseTitle: "Complete your payment",
    paymentPhaseSubtitle: "Pay before the time runs out to secure your airing schedule.",
    timerLabelHold: "Time left:",
    timerConsequenceNote: "If the time runs out, the schedule is released to other advertisers. Your survey details stay saved.",
    // Jadwal yang dibuat admin tidak punya umur — lihat utils/slotHold.ts.
    slotHeldByAdminLabel: "Schedule held for you by our team",
    slotHeldByAdminNote: "This schedule has no countdown — it is not released automatically. Our team will confirm the schedule with you.",
    // Batas 14.00 WIB lewat, tapi slotnya TIDAK dilepas.
    paymentPastCutoffTitle: "That date can no longer be met",
    paymentPastCutoffBody: "The 14:00 WIB payment cut-off for that date has passed, so the ad cannot go live then. Your schedule has not been released — you can still pay, and our team will confirm the new airing date with you.",
    ...
    cancelScheduleSuccess: "Order cancelled. The date has been released — book a new schedule from your dashboard whenever you're ready.",
    ...
    successContinuePayment: "Continue payment",
    successBackToPaymentHint: "Takes you back to the payment page for this bill.",
    successInvoiceLabel: "Invoice number",
    successBillUnreadable: "We couldn't read this bill's amount right now — open My Order to see it.",
    ...
    errorSlotFullKilat: "Kilat quota for that date is full. Please pick another date.",
    errorSlotFullRange: "Quota in that date range is full. Please pick another date.",
    errorAvailabilityCheck: "Failed to check schedule availability. Please try again.",
    ...
    jfuFormHintPart1: "Faster review approval & real-time monitoring — use",
    jfuFormHintPart2: ", import questions from Google Forms & other survey platforms.",
    ...
    calloutPayBeforeSuffix: "or the reserved schedule will be released.",
    ...
    calloutExpired: "Payment expired and the reserved schedule was released. Pick a new schedule — no need to resubmit.",
    ...
    scheduleAgainTitle: "Schedule Another Ad",
    scheduleAgainDesc: "Pick the start date for your next airing window. The schedule is held for 1 hour — pay within that time to keep it.",
    scheduleAgainDuration: "Airing length",
    scheduleAgainDays: "days",
    scheduleAgainRewardTitle: "This Schedule Enters a New Period",
    scheduleAgainRewardWhy: "This schedule's reward will enter distribution when your ad airs on the date selected above. Please set a new reward for this period.",
    scheduleAgainRewardPrize: "Prize",
    scheduleAgainRewardWinners: "Winners",
    scheduleAgainPoolReused: "Previous rewards are automatically reused with no additional fee.",
    scheduleAgainPeriodRewardTitle: "Respondent Reward ({period})",
    scheduleAgainSamePeriodFreeBadge: "✓ Active Reward",
    scheduleAgainActiveBadge: "Active & Reused",
    scheduleAgainDistributingBadge: "Distribution Process",
    scheduleAgainNewPeriodBadge: "New Period",
    scheduleAgainSamePeriodTooltip: "This airing schedule falls within the same period. Respondents who complete your survey will be raffled from previously allocated rewards at no extra cost.",
    scheduleAgainNewPeriodTooltip: "This schedule enters a new period ({currentPeriod}). Rewards from the previous period ({prevAmount}) are allocated to respondents of that period, so airings in this new period require their own reward allocation.",
    rewardQuickOptionsLabel: "QUICK PRIZE OPTIONS",
    minPrizeBadge: "Minimum Limit",
    minAndRecommendedBadge: "Minimum & Recommended",
    recommendedBadge: "Recommended",
    customPrizeLabel: "Custom Amount",
    customPrizeSubtitle: "Custom",
    rewardMinProportionalHint: "Minimum limit {amount} (proportional for a {count}-question survey).",
    rewardMinHint: "Minimum limit {amount} per winner.",
    rewardApplyRecommendation: "Set {amount}",
    rewardResetToMin: "Reset to {amount} min",
    rewardRecommendationMatches: "✓ Matches recommendation for a {count}-question survey (min. {minAmount}).",
    rewardRecommendationDefault: "✓ Matches minimum recommendation (min. {minAmount} per winner).",
    rewardAboveRecommendation: "✓ Above recommendation for a {count}-question survey. Respondents will be more engaged.",
    rewardAboveDefault: "✓ Above minimum limit (min. {minAmount}). Respondents will be more engaged.",
    rewardSuggestionPrefix: "Suggestion:",
    rewardAttractivenessNote: "The more attractive the reward, the faster respondents complete it.",
    rewardAttractivenessNoteWithMin: "The more attractive the reward, the faster respondents complete it (minimum {amount}).",
    rewardEducationNote: "The more attractive the reward offered, the more interested respondents will be in your survey ad on the Jakpat app.",
    rewardEducationNoteWithQuestions: "The more attractive the reward offered, the more interested respondents will be in your survey ad on the Jakpat app (especially for a survey with {count} questions).",
    totalRewardTitle: "Total Reward Funds",
    billedInInvoiceBadge: "Billed in Invoice",
    totalRewardDetailNote: "Details: {winners} respondents × {prize} (distributed automatically by Jakpat)",
    totalRewardCommitment: "Total reward commitment: {total} ({prize} × {winners} winners)",
    totalRewardSummary: "Total reward commitment ({prize} × {winners} winners)",
    topupEducationNote: "Increasing the reward makes your survey ad stand out more to Jakpat respondents.",
    scheduleAgainSamePeriodDesc: "Previous rewards are automatically reused with no additional fee.",
    scheduleAgainSamePeriodPoolTotal: "Total Pool:",
    scheduleAgainSamePeriodNotice: "This schedule falls within the same period. Respondent rewards from your previous schedule are automatically reused at no extra cost.",
    scheduleAgainNewPeriodNoticeTitle: "Why is a new reward needed?",
    scheduleAgainNewPeriodNoticeDesc: "This schedule enters **{currentPeriod}**. Rewards for {prevPeriod} ({prevAmount}) have been allocated to respondents from that period.",
    scheduleAgainNewPeriodFormPrompt: "Set respondent rewards for this {period} airing:",
    scheduleAgainNewPeriodPrefilledHint: "(Automatically matched with previous period's reward)",
    scheduleAgainPrevDistributingDesc: "This schedule's reward will **enter the distribution process** when your ad airs on the **schedule you selected**.",
    scheduleAgainNewPeriodDesc: "Schedule enters a new period. Set respondent reward for this period:",
    scheduleAgainAddRewardToggle: "Add prize to make ad more attractive (Optional)",
    scheduleAgainCloseRewardToggle: "Close prize addition",
    scheduleAgainTopupHint: "Add prize per winner (number of winners remains {count}):",
    scheduleAgainTopupLabel: "Additional per winner",
    scheduleAgainTopupTotalTitle: "Additional Reward Cost",
    scheduleAgainTotalBecomes: "Total prize becomes: {amount} / winner",
    scheduleAgainAdditionalCost: "Additional reward cost: +{amount}",
    scheduleAgainTotalPrizeNewPeriod: "Total reward for this period",
    scheduleForOrderLabel: "Survey:",
    costLineAd: "Ad",
    costLineVoucher: "Voucher discount",
    costLineVoucherNamed: "Voucher discount ({code})",
    costLineKilatAddon: "JFU Kilat add-on",
    costLineReward: "Respondent reward",
    costLineSubtotal: "Subtotal (tax base)",
    costLinePpn: "VAT 11%",
    costHintDays: "{d} days",
    costHintQsDays: "{q} Qs x {d} days",
    slotLegendTitle: "Numbers show quota already taken.",
    slotLegendOpen: "Open",
    slotLegendFilling: "Filling fast",
    slotLegendFull: "Full",
    slotFullLabel: "Full",
    slotFullReason: "Quota for this date is full.",
    slotClosedReason: "Booking for today closed at 13.00 WIB.",
    costSavingLabel: "You save",
    scheduleAgainBatchResolving: "Checking period for this airing schedule…",
    scheduleAgainBatchUnknown: "We couldn't confirm the period for this airing schedule. Please pick the date again.",
    scheduleAgainRewardRequired: "Please set the respondent reward first for this new period.",
    scheduleAgainHoldNote: "The airing schedule is <b>held for 1 hour</b> once locked. Complete the payment within that window so the airing date isn't released.",
    scheduleAgainPickDate: "Pick the airing start date",
    scheduleAgainNotPicked: "Not picked yet",
    scheduleAgainTotalPrize: "Total respondent prize",
    scheduleAgainDurationLess: "Decrease duration",
    scheduleAgainDurationMore: "Increase duration",
    scheduleAgainCreated: "Schedule locked. Complete the payment to secure the date.",
    scheduleAgainSubmit: "Lock Schedule & Continue to Payment",
    scheduleAgainBooking: "Locking the schedule…",
    ...
    scheduleAgainOrphanLeft: "The schedule was saved but its invoice was not, and we could not release it again. Please contact our team before trying another date — quoting this order.",
    ...
    */
    ...
    bannerSubWaitingPaymentSlotsLimited: "Daily airing quota is limited. Complete your payment before your date fills up.",
    ...
    */
    ...
    // Placeholders
    scheduleSlotReleased: "Schedule released (reschedule needed)",
    ...
    scheduleTicketNumbered: "Schedule #{index}",
    ...
    publicationCtaBtn: "Try Data Analyzer",
    ...
    specialMissionLabel: "NON-SURVEY RESEARCH",
    specialMissionTooltip: "Click to request Custom Missions & Respondent Actions",
    specialMissionBannerPart1: "Need custom respondent actions for",
    specialMissionBannerMysteryShopping: "Mystery Shopping",
    specialMissionBannerAppTesting: "App/Website Testing",
    specialMissionBannerProductTasting: "Product Tasting",
    specialMissionBannerOr: "or",
    specialMissionBannerValidation: "Idea Validation",
    specialMissionApply: "Consult Mission",

    // Custom Mission Modal (Riset Non-Survei)
    cmModalTitle: "Non-Survey Research (Special Mission)",
    cmModalDesc: "Brief real tasks & actions for Jakpat respondents",
    cmGuardrailText: "Looking to distribute standard questionnaires (Google Forms)?",
    cmGuardrailLink: "Create Survey Ad here",
    cmActionType: "Respondent Action Type",
    cmCatMysteryTitle: "Mystery Shopping",
    cmCatMysteryTag: "Store Visit & Review",
    cmCatMysteryDesc: "Store/booth visits, product testing, & receipt submission.",
    cmCatAppTitle: "App & Web Testing",
    cmCatAppTag: "Feature Trial & UX Testing",
    cmCatAppDesc: "Feature trials on web/Figma, UX/SUS usability testing, & bug reports.",
    cmCatTastingTitle: "Product Tasting / Sampling",
    cmCatTastingTag: "Product Sample Trial",
    cmCatTastingDesc: "Physical product sample trials (food, beverage, or cosmetics).",
    cmCatValidationTitle: "Business Idea Validation",
    cmCatValidationTag: "Concept Test & Market Analysis",
    cmCatValidationDesc: "Product concept testing, willingness to pay (WTP), & market analysis.",
    cmCatOtherTitle: "Other Custom Action",
    cmCatOtherTag: "Custom Research Scenario",
    cmCatOtherDesc: "Custom specific action (describe your scenario below).",
    cmCustomCatLabel: "Describe Your Custom Research Needs",
    cmCustomCatPlaceholder: "e.g., Respondents vote on poster submissions at a campus festival...",
    cmTargetRespondents: "Target Respondents",
    cmMinRespondents: "Min. 5 people",
    cmPersonUnit: "People",
    cmExecutionPeriod: "Execution Period",
    cmDaysUnit: "Days",
    cmBriefLabel: "Task Brief & Instructions (Optional)",
    cmBriefSubLabel: "Respondent task guidance",
    cmBriefPlaceholder: "e.g., Respondents test web/app, submit screenshot proof, and provide user experience (UX) reviews...",
    cmLinkLabel: "Prototype / Website Link (Optional)",
    cmLinkPlaceholder: "https://figma.com/... or https://website.com...",
    cmContactSectionTitle: "Applicant Contact",
    cmContactSectionSubtitle: "For mission brief confirmation & cost estimation",
    cmContactName: "Full Name",
    cmContactNamePlaceholder: "Your Name",
    cmContactWhatsapp: "Active WhatsApp Number",
    cmContactWhatsappPlaceholder: "08123456789",
    cmSubmitBtn: "Submit Mission Consultation Request",
    cmSubmitting: "Submitting Request...",
    cmSuccessTitle: "Request Successfully Sent!",
    cmSuccessMsgPart1: "Thank you,",
    cmSuccessMsgPart2: "! Your special task & research requirements have been received.",
    cmNextStepTitle: "⏱️ What's next?",
    cmNextStepDescPart1: "The Jakpat for Universities team will review your task brief and contact your WhatsApp number (",
    cmNextStepDescPart2: ") to confirm mission details, cost estimation, & execution schedule.",
    cmBackToDashboard: "Close & Back to Dashboard",
    errContactNameRequired: "Please fill in applicant full name.",
    errContactWhatsappRequired: "Please fill in active WhatsApp number.",
    errMinRespondents: "Target respondents must be at least 5 people.",
    errCustomCategoryRequired: "Please explain your custom research requirements.",
    cmSubmitSuccessToast: "Special Mission & Action request successfully sent!",
    cmSubmitFailedToast: "Failed to submit request",
  ...
  id: {
    ...
    prizePerWinnerLabel: "Hadiah",
    prizePerWinnerPlaceholder: "25.000",
    winnerCountLabel: "Pemenang",
    winnerCountPlaceholder: "2",
    winnerCountUnit: "pemenang",
    respondentUnit: "responden",
    ...
    slotErrorFull: "Kuota pada rentang tanggal yang dipilih sudah penuh. Silakan pilih tanggal lain.",
    slotErrorAvailabilityUnknown: "Ketersediaan jadwal belum berhasil dimuat, jadi tanggal ini belum bisa dikunci. Silakan coba lagi.",
    slotAvailabilityRetry: "Muat ulang ketersediaan jadwal",
    ...
    scheduleHoldHint: "Jadwal ditahan 1 jam setelah dikunci supaya kamu sempat menyelesaikan pembayaran.",
    ...
    lockingSlotLoading: "Mengunci jadwal...",
    ...
    paymentPhaseSubtitle: "Bayar sebelum batas waktu untuk mengamankan jadwal tayang.",
    timerLabelHold: "Sisa waktu:",
    timerConsequenceNote: "Kalau waktunya habis, jadwal dilepas untuk pemesan lain. Detail surveimu tetap tersimpan.",
    // Jadwal yang dibuat admin tidak punya umur — lihat utils/slotHold.ts.
    slotHeldByAdminLabel: "Jadwal ditahan khusus untukmu",
    slotHeldByAdminNote: "Jadwal ini tidak punya hitung mundur dan tidak dilepas otomatis. Tim kami akan mengonfirmasi jadwalnya denganmu.",
    // Batas 14.00 WIB lewat, tapi slotnya TIDAK dilepas.
    paymentPastCutoffTitle: "Tanggal ini sudah tidak bisa dikejar",
    paymentPastCutoffBody: "Batas bayar 14.00 WIB untuk tanggal itu sudah lewat, jadi iklanmu tidak bisa tayang di tanggal tersebut. Jadwalmu tidak dilepas — kamu tetap bisa membayar, dan tim kami akan mengonfirmasi tanggal tayang barunya denganmu.",
    ...
    cancelScheduleSuccess: "Pesanan dibatalkan. Tanggalnya sudah dilepas — buat jadwal baru dari dashboard kapan pun kamu siap.",
    ...
    successContinuePayment: "Lanjutkan Pembayaran",
    successBackToPaymentHint: "Membawamu kembali ke halaman pembayaran tagihan ini.",
    successInvoiceLabel: "Nomor tagihan",
    successBillUnreadable: "Rincian tagihan belum bisa dibaca sekarang — buka My Order untuk melihatnya.",
    ...
    errorSlotFullKilat: "Kuota Kilat pada tanggal itu sudah penuh. Silakan pilih tanggal lain.",
    errorSlotFullRange: "Kuota pada rentang tanggal itu sudah penuh. Silakan pilih tanggal lain.",
    errorAvailabilityCheck: "Gagal mengecek ketersediaan jadwal. Silakan coba lagi.",
    ...
    statusInReview: "Under Review",
    statusWaitingPayment: "Awaiting Payment",
    statusScheduling: "Jadwal Direservasi",
    statusScheduled: "Scheduled",
    statusPublishing: "Ready to Launch",
    statusCompleted: "Completed 🎉",
    ...
    billNotIssuedYet: "Jadwalmu sudah terkunci. Tagihannya sedang disiapkan tim kami — kami kirim lewat email begitu siap.",
    ...
    noSubmissionsDesc: "Kamu belum mengajukan survei untuk didistribusikan. Pilih salah satu layanan di atas atau buat kuesioner baru untuk memulai.",
    ...
    voucherTitle: "Kode Voucher / Referral",
    ...
    jfuFormHintPart1: "Lebih cepat lolos review & monitoring langsung hasilnya — pakai",
    jfuFormHintPart2: ", bisa import pertanyaan dari Google Form & platform survey lainnya.",
    ...
    calloutPayBeforeSuffix: "agar jadwal tayang tidak hangus.",
    ...
    calloutExpired: "Pembayaran kedaluwarsa dan jadwal tayang dilepas. Pilih jadwal baru — tidak perlu submit ulang.",
    ...
    scheduleAgainTitle: "Jadwalkan Iklan Lagi",
    scheduleAgainDesc: "Pilih tanggal mulai tayang berikutnya. Jadwal ditahan 1 jam — selesaikan pembayaran dalam waktu itu supaya tanggalnya tidak lepas.",
    scheduleAgainDuration: "Lama tayang",
    scheduleAgainDays: "hari",
    scheduleAgainRewardTitle: "Jadwal Ini Masuk ke Periode Baru",
    scheduleAgainRewardWhy: "Hadiah penayangan ini akan masuk proses distribusi saat iklan tayang pada jadwal di atas. Silakan tentukan hadiah baru untuk periode ini.",
    scheduleAgainRewardPrize: "Hadiah",
    scheduleAgainRewardWinners: "Pemenang",
    scheduleAgainPoolReused: "Hadiah penayangan sebelumnya otomatis digunakan kembali tanpa biaya tambahan.",
    scheduleAgainPeriodRewardTitle: "Hadiah Responden ({period})",
    scheduleAgainSamePeriodFreeBadge: "✓ Hadiah Aktif",
    scheduleAgainActiveBadge: "Aktif Digunakan",
    scheduleAgainDistributingBadge: "Proses Pendistribusian",
    scheduleAgainNewPeriodBadge: "Periode Baru",
    scheduleAgainSamePeriodTooltip: "Jadwal tayang ini berada di periode yang sama. Responden yang mengisi surveimu akan diundi dari hadiah yang sudah dialokasikan sebelumnya tanpa biaya hadiah tambahan.",
    scheduleAgainNewPeriodTooltip: "Jadwal ini masuk periode baru ({currentPeriod}). Hadiah periode sebelumnya ({prevAmount}) telah dialokasikan khusus untuk responden periode tersebut, sehingga penayangan di periode baru ini membutuhkan alokasi hadiah tersendiri.",
    rewardQuickOptionsLabel: "PILIHAN CEPAT HADIAH",
    minPrizeBadge: "Batas Minimal",
    minAndRecommendedBadge: "Minimal & Rekomendasi",
    recommendedBadge: "Rekomendasi",
    customPrizeLabel: "Nominal Lain",
    customPrizeSubtitle: "Kustom",
    rewardMinProportionalHint: "Batas minimal {amount} (sudah proporsional untuk survei {count} pertanyaan).",
    rewardMinHint: "Batas minimal {amount} per pemenang.",
    rewardApplyRecommendation: "Pasang {amount}",
    rewardResetToMin: "Kembalikan ke {amount} minimal",
    rewardRecommendationMatches: "✓ Sesuai rekomendasi untuk survei {count} pertanyaan (min. {minAmount}).",
    rewardRecommendationDefault: "✓ Sesuai rekomendasi batas minimal (min. {minAmount} per pemenang).",
    rewardAboveRecommendation: "✓ Di atas rekomendasi untuk survei {count} pertanyaan. Responden akan lebih antusias.",
    rewardAboveDefault: "✓ Di atas batas minimal (min. {minAmount}). Responden akan lebih antusias.",
    rewardSuggestionPrefix: "Saran:",
    rewardAttractivenessNote: "Semakin menarik reward, responden semakin antusias.",
    rewardAttractivenessNoteWithMin: "Semakin menarik reward, responden semakin antusias (batas minimal {amount}).",
    rewardEducationNote: "Semakin menarik reward yang ditawarkan, iklan surveimu akan semakin diminati responden di aplikasi Jakpat.",
    rewardEducationNoteWithQuestions: "Semakin menarik reward yang ditawarkan, iklan surveimu akan semakin diminati responden di aplikasi Jakpat (terutama untuk survei dengan {count} pertanyaan).",
    totalRewardTitle: "Total Dana Hadiah",
    billedInInvoiceBadge: "Masuk Tagihan",
    totalRewardDetailNote: "Rincian: {winners} responden × {prize} (disalurkan otomatis oleh Jakpat)",
    totalRewardCommitment: "Total komitmen reward: {total} ({prize} × {winners} pemenang)",
    totalRewardSummary: "Total komitmen reward ({prize} × {winners} pemenang)",
    topupEducationNote: "Menaikkan reward akan membuat iklan surveimu makin menonjol di hadapan responden Jakpat.",
    scheduleAgainSamePeriodDesc: "Hadiah penayangan sebelumnya otomatis digunakan kembali tanpa biaya tambahan.",
    scheduleAgainSamePeriodPoolTotal: "Total Pool:",
    scheduleAgainSamePeriodNotice: "Jadwal tayang ini berada di periode yang sama. Hadiah responden dari penayangan sebelumnya otomatis digunakan kembali tanpa biaya tambahan.",
    scheduleAgainNewPeriodNoticeTitle: "Mengapa butuh hadiah baru?",
    scheduleAgainNewPeriodNoticeDesc: "Jadwal ini masuk periode **{currentPeriod}**. Hadiah periode {prevPeriod} ({prevAmount}) telah dialokasikan untuk responden periode tersebut.",
    scheduleAgainNewPeriodFormPrompt: "Tentukan hadiah responden untuk penayangan di periode {period} ini:",
    scheduleAgainNewPeriodPrefilledHint: "(Otomatis disamakan dengan hadiah periode sebelumnya)",
    scheduleAgainPrevDistributingDesc: "Hadiah penayangan ini akan **masuk pada proses distribusi** ketika iklan ditayangkan pada **jadwal yang kamu pilih**.",
    scheduleAgainNewPeriodDesc: "Jadwal masuk periode baru. Tentukan hadiah responden untuk periode ini:",
    scheduleAgainAddRewardToggle: "Tambah nominal hadiah agar iklan lebih menarik (Opsional)",
    scheduleAgainCloseRewardToggle: "Tutup penambahan nominal",
    scheduleAgainTopupHint: "Tambah nominal per pemenang (jumlah pemenang tetap {count}):",
    scheduleAgainTopupLabel: "Tambahan per pemenang",
    scheduleAgainTopupTotalTitle: "Tambahan Biaya Hadiah",
    scheduleAgainTotalBecomes: "Total hadiah menjadi: {amount} / pemenang",
    scheduleAgainAdditionalCost: "Biaya tambahan hadiah: +{amount}",
    scheduleAgainTotalPrizeNewPeriod: "Total hadiah periode ini",
    scheduleForOrderLabel: "Survei:",
    costLineAd: "Iklan",
    costLineVoucher: "Diskon voucher",
    costLineVoucherNamed: "Diskon voucher ({code})",
    costLineKilatAddon: "Add-on JFU Kilat",
    costLineReward: "Hadiah responden",
    costLineSubtotal: "Subtotal (DPP)",
    costLinePpn: "PPN 11%",
    costHintDays: "{d} hari",
    costHintQsDays: "{q} Qs x {d} hari",
    slotLegendTitle: "Angka menunjukkan kuota yang sudah terisi.",
    slotLegendOpen: "Tersedia",
    slotLegendFilling: "Hampir penuh",
    slotLegendFull: "Penuh",
    slotFullLabel: "Penuh",
    slotFullReason: "Kuota tanggal ini sudah penuh.",
    slotClosedReason: "Pemesanan untuk hari ini ditutup pukul 13.00 WIB.",
    costSavingLabel: "Kamu hemat",
    scheduleAgainBatchResolving: "Memeriksa periode untuk jadwal tayang ini…",
    scheduleAgainBatchUnknown: "Periode untuk jadwal tayang ini belum bisa dipastikan. Silakan pilih tanggalnya lagi.",
    scheduleAgainRewardRequired: "Tentukan hadiah responden terlebih dahulu untuk periode baru ini.",
    scheduleAgainHoldNote: "Jadwal tayang akan <b>ditahan selama 1 jam</b> setelah dikunci. Selesaikan pembayaran dalam kurun waktu tersebut agar tanggal tayang tidak dilepas.",
    scheduleAgainPickDate: "Pilih tanggal mulai tayang",
    scheduleAgainNotPicked: "Belum dipilih",
    scheduleAgainTotalPrize: "Total hadiah responden",
    scheduleAgainDurationLess: "Kurangi durasi",
    scheduleAgainDurationMore: "Tambah durasi",
    scheduleAgainCreated: "Jadwal terkunci. Selesaikan pembayaran agar tanggalnya aman.",
    scheduleAgainSubmit: "Kunci Jadwal & Lanjut Bayar",
    scheduleAgainBooking: "Mengunci jadwal…",
    ...
    scheduleAgainOrphanLeft: "Jadwalnya tersimpan tetapi tagihannya tidak, dan kami gagal melepasnya kembali. Hubungi tim kami dulu sebelum mencoba tanggal lain — sebutkan order ini.",
    // Kalimat yang menggantikan tombol saat ia disembunyikan. ⚠️ Tanpa ini
    // tombolnya sekadar lenyap tanpa sebab — kebisuan yang sama dengan yang
    // ditutup 65369c1. Kontrak scheduleCardActions.ts: aksi DIHILANGKAN,
    // bukan disabled, dan alasannya dititipkan ke kartu.
    ...
    bannerSubWaitingPaymentSlotsLimited: "Kuota iklan terbatas setiap hari. Selesaikan pembayaran sebelum tanggalmu terisi.",
    ...
    // Placeholders
    scheduleSlotReleased: "Jadwal tayang dilepas (perlu dijadwalkan ulang)",
    ...
    scheduleTicketNumbered: "Jadwal #{index}",
    ...
    publicationCtaBtn: "Coba Olah Data",
    ...
    // Special Mission Running Banner
    specialMissionLabel: "RISET NON-SURVEI",
    specialMissionTooltip: "Klik untuk mengajukan Misi & Aksi Khusus Responden",
    specialMissionBannerPart1: "Butuh aksi khusus responden untuk",
    specialMissionBannerMysteryShopping: "Mystery Shopping",
    specialMissionBannerAppTesting: "Uji Aplikasi & Web",
    specialMissionBannerProductTasting: "Tasting Produk",
    specialMissionBannerOr: "atau",
    specialMissionBannerValidation: "Validasi Ide",
    specialMissionApply: "Konsultasi Misi",

    // Custom Mission Modal (Riset Non-Survei)
    cmModalTitle: "Riset Non-Survei (Misi Khusus)",
    cmModalDesc: "Brief aksi & tugas riil responden Jakpat",
    cmGuardrailText: "Ingin menyebarkan survei kuesioner biasa (Google Form)?",
    cmGuardrailLink: "Buat Iklan Survei di sini",
    cmActionType: "Jenis Aksi Responden",
    cmCatMysteryTitle: "Mystery Shopping",
    cmCatMysteryTag: "Kunjungan Toko & Review",
    cmCatMysteryDesc: "Kunjungan toko/booth, coba produk, & kirim bukti struk belanja.",
    cmCatAppTitle: "Uji Aplikasi & Web",
    cmCatAppTag: "Trial Fitur & Pengujian UX",
    cmCatAppDesc: "Trial fitur di website/Figma, pengujian UX/SUS, & laporan bug.",
    cmCatTastingTitle: "Product Tasting / Sampel",
    cmCatTastingTag: "Uji Coba Sampel Produk",
    cmCatTastingDesc: "Uji coba fisik sampel produk (makanan, minuman, atau kosmetik).",
    cmCatValidationTitle: "Validasi Ide Bisnis",
    cmCatValidationTag: "Uji Konsep & Analisis Pasar",
    cmCatValidationDesc: "Uji konsep produk, kesediaan bayar (WTP), & analisis pasar.",
    cmCatOtherTitle: "Kebutuhan Aksi Lainnya",
    cmCatOtherTag: "Skenario Riset Bebas",
    cmCatOtherDesc: "Kebutuhan aksi khusus custom (tuliskan skenario bebas di bawah).",
    cmCustomCatLabel: "Jelaskan Kebutuhan Riset Khusus Anda",
    cmCustomCatPlaceholder: "Contoh: Responden diminta vote karya poster di festival kampus...",
    cmTargetRespondents: "Target Responden",
    cmMinRespondents: "Min. 5 orang",
    cmPersonUnit: "Orang",
    cmExecutionPeriod: "Periode Pelaksanaan",
    cmDaysUnit: "Hari",
    cmBriefLabel: "Brief Tugas & Instruksi (Opsional)",
    cmBriefSubLabel: "Panduan tugas responden",
    cmBriefPlaceholder: "Contoh: Responden mencoba web/app, kirim bukti screenshot, dan beri ulasan kepuasan pengguna (UX)...",
    cmLinkLabel: "Tautan Prototipe / Website (Opsional)",
    cmLinkPlaceholder: "https://figma.com/... atau https://website.com...",
    cmContactSectionTitle: "Kontak Pemohon",
    cmContactSectionSubtitle: "Untuk konfirmasi brief misi & estimasi biaya",
    cmContactName: "Nama Lengkap",
    cmContactNamePlaceholder: "Nama Anda",
    cmContactWhatsapp: "Nomor WhatsApp Aktif",
    cmContactWhatsappPlaceholder: "08123456789",
    cmSubmitBtn: "Kirim Permintaan Konsultasi Misi",
    cmSubmitting: "Mengirim Permintaan...",
    cmSuccessTitle: "Permintaan Berhasil Terkirim!",
    cmSuccessMsgPart1: "Terima kasih,",
    cmSuccessMsgPart2: "! Kebutuhan tugas dan riset khususmu telah kami terima.",
    cmNextStepTitle: "⏱️ Apa langkah selanjutnya?",
    cmNextStepDescPart1: "Tim Jakpat for Universities akan segera mereview brief tugas dan menghubungi nomor WhatsApp Anda (",
    cmNextStepDescPart2: ") untuk konfirmasi detail misi, estimasi biaya, & jadwal pelaksanaan.",
    cmBackToDashboard: "Tutup & Kembali ke Dashboard",
    errContactNameRequired: "Mohon isi nama lengkap pemohon.",
    errContactWhatsappRequired: "Mohon isi nomor WhatsApp aktif untuk dihubungi tim.",
    errMinRespondents: "Target jumlah responden minimal 5 orang.",
    errCustomCategoryRequired: "Mohon jelaskan jenis kebutuhan riset khusus Anda.",
    cmSubmitSuccessToast: "Permintaan Misi & Aksi Khusus berhasil dikirim!",
    cmSubmitFailedToast: "Gagal mengirim permintaan",
