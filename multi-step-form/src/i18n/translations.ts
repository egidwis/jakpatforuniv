...
export const translations = {
  en: {
    ...
    scheduleAgainDesc: "Pick the start date for your next airing window. The slot is held for 1 hour — pay within that time to keep it.",
    ...
    scheduleAgainBooking: "Locking the slot…",
  ...
  id: {
    ...
    scheduleAgainDesc: "Pilih tanggal mulai tayang berikutnya. Slotnya ditahan 1 jam — selesaikan pembayaran dalam waktu itu supaya tanggalnya tidak lepas.",
    ...
    scheduleAgainBooking: "Mengunci slot…",
