...
export const translations = {
  en: {
    ...
    */
    ...
    scheduleAgainPeriodRewardTitle: "Reward for {period}",
    ...
    scheduleAgainAddRewardToggle: "Add reward to make ad more attractive (Optional)",
    scheduleAgainCloseRewardToggle: "Close extra reward",
    scheduleAgainTopupHint: "Add prize per winner (number of winners remains {count}):",
    scheduleAgainTopupLabel: "Additional per winner",
    scheduleAgainTotalBecomes: "Total prize becomes: {amount} / winner ({count} winners)",
    scheduleAgainAdditionalCost: "Additional cost: +{amount}",
  ...
  id: {
    ...
    scheduleAgainPeriodRewardTitle: "Hadiah Periode {period}",
    ...
    scheduleAgainAddRewardToggle: "Tambah reward agar iklan lebih menarik (Opsional)",
    scheduleAgainCloseRewardToggle: "Tutup penambahan reward",
    ...
    scheduleAgainTotalBecomes: "Total hadiah menjadi: {amount} / pemenang ({count} pemenang)",
    scheduleAgainAdditionalCost: "Biaya tambahan: +{amount}",
