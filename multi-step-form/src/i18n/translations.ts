...
export const translations = {
  en: {
    ...
    productAdsDesc: "Air your survey in front of thousands of active Jakpat respondents, every day.",
    productKilatTitle: "Kilat",
    productKilatHook: "For maximum speed —",
    productKilatDesc: "Express distribution via push notification in the Jakpat app",
  ...
  id: {
    ...
    airingDateLabel: "Tanggal Tayang",
    ...
    rewardRespondentLabel: "Reward Respondent",
