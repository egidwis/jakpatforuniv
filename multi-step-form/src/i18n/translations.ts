...
export const translations = {
  en: {
    ...
    slotErrorFull: "Slots for the selected date range are full. Please choose a different date.",
    ...
    */
    ...
    scheduleAgainRewardTitle: "Reward for the new batch",
    // ⚠️ Menjelaskan KENAPA hadiah ditagih lagi. 43% perpanjangan mendarat di
    // batch baru, dan tanpa kalimat ini penelitinya membaca tagihan kedua
    // sebagai kesalahan.
    scheduleAgainRewardWhy: "This window ends in a new monthly batch, so it needs its own prize pool. The previous batch's prize stays with that batch.",
    scheduleAgainRewardPrize: "Prize per winner",
    scheduleAgainRewardWinners: "Number of winners",
    scheduleAgainPoolReused: "This window lands in a batch that already has a funded prize pool, so no extra reward is charged.",
    ...
    slotLegendTitle: "Numbers show slots already taken out of the daily quota.",
    slotLegendOpen: "Open",
    slotLegendFilling: "Filling up",
    slotLegendFull: "Full",
    slotFullLabel: "Full",
    slotFullReason: "All slots for this date are taken.",
    slotClosedReason: "Booking for today closed at 13.00 WIB.",
    costSavingLabel: "You save",
    scheduleAgainBatchResolving: "Checking which prize batch this window falls into…",
    scheduleAgainBatchUnknown: "We couldn't confirm which prize batch this window falls into. Please pick the date again.",
    scheduleAgainRewardRequired: "Fill in the prize first — this window opens a new batch.",
    scheduleAgainHoldNote: "The slot is <b>held for 1 hour</b> once locked. Complete the payment within that window so the airing date isn't released.",
  ...
  id: {
    ...
    slotErrorFull: "Slot pada rentang tanggal yang dipilih sudah penuh. Silakan pilih tanggal lain.",
    ...
    scheduleAgainRewardTitle: "Hadiah untuk batch baru",
    // ⚠️ Menjelaskan KENAPA hadiah ditagih lagi. 43% perpanjangan mendarat di
    // batch baru, dan tanpa kalimat ini penelitinya membaca tagihan kedua
    // sebagai kesalahan.
    scheduleAgainRewardWhy: "Jendela tayang ini berakhir di batch bulan baru, jadi ia butuh kolam hadiahnya sendiri. Hadiah batch sebelumnya tetap milik batch itu.",
    scheduleAgainRewardPrize: "Hadiah per pemenang",
    scheduleAgainRewardWinners: "Jumlah pemenang",
    scheduleAgainPoolReused: "Jendela tayang ini masuk batch yang kolam hadiahnya sudah didanai, jadi tidak ada hadiah tambahan yang ditagih.",
    ...
    slotLegendTitle: "Angka menunjukkan slot yang sudah terisi dari kuota harian.",
    slotLegendOpen: "Tersedia",
    slotLegendFilling: "Hampir penuh",
    slotLegendFull: "Penuh",
    slotFullLabel: "Penuh",
    slotFullReason: "Semua slot tanggal ini sudah terisi.",
    slotClosedReason: "Pemesanan untuk hari ini ditutup pukul 13.00 WIB.",
    costSavingLabel: "Kamu hemat",
    scheduleAgainBatchResolving: "Memeriksa batch hadiah untuk jendela tayang ini…",
    scheduleAgainBatchUnknown: "Batch hadiah untuk jendela tayang ini belum bisa dipastikan. Silakan pilih tanggalnya lagi.",
    scheduleAgainRewardRequired: "Isi hadiah dulu — jendela ini membuka batch baru.",
    scheduleAgainHoldNote: "Slot jadwal akan <b>ditahan selama 1 jam</b> setelah dikunci. Selesaikan pembayaran dalam kurun waktu tersebut agar tanggal tayang tidak dilepas.",
