    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 border-b pb-5">
        ...
        <div className="hidden md:block">
          <div className="flex items-center p-1 bg-gray-100 dark:bg-gray-800 rounded-xl border border-gray-200/80 dark:border-gray-700/80 shadow-2xs">
            <button
              type="button"
      ...
      {/* Mobile Navigation Tabs (Pertanyaan vs Respon) - Mobile Only */}
      <div className="md:hidden -mt-2 mb-4">
        <div className="flex items-center w-full max-w-xs mx-auto p-1 bg-gray-100 dark:bg-gray-800 rounded-xl border border-gray-200/80 dark:border-gray-700/80 shadow-2xs">
          <button
            type="button"
            onClick={() => navigate(`/dashboard/forms/${form.id}/edit`)}
